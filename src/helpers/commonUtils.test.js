...
describe('helpers/commonUtils.js', function() {
  ...
  describe('prepEntry()', function() {
    it('removes unsupported properties from both entry and ' +
       'term-objects', function() {
      var orig = {
  ...
  describe('zPropPrune()', function() {
    it('leaves an Object\'s z-property unchanged if argument 2 is ' +
       '`true`', function() {
    ...
    it('removes the z-property if arg. 2 only holds a key not in ' +
       '`z`', function() {
    ...
    it('keeps only the z-properties given in argument 2', function() {
